...
def options() :
    ...
    print ("-t, --targetnode followed by a nodeID for the device under test in 01.23.45.67.89.0A form")
    print ("")
    ...
    print ("-o, --ownnode followed by a nodeID for the testing device in 01.23.45.67.89.0A form")
