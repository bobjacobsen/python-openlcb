...
class DatagramServiceTest(unittest.TestCase) :
    ...
    def testDatagramType(self) :
        self.assertEqual(self.service.datagramType([]), DatagramService.ProtocolID.Unrecognized)
        self.assertEqual(self.service.datagramType([0,2,3]), DatagramService.ProtocolID.Unrecognized)
        
        self.assertEqual(self.service.datagramType([0x20,2,3]), DatagramService.ProtocolID.MemoryOperation)
    ...
    def testSendDatagramOK(self) :
        writeMemo = DatagramWriteMemo(NodeID(22), [0x20, 0x42, 0x30], self.writeCallBackCheck)
    ...
    def testSendThreeDatagramOK(self) :
        ...
        self.assertEqual(len(LinkMockLayer.sentMessages), 1) # only first is send until reply
    ...
    def testSendDatagramRejected(self) :
        writeMemo = DatagramWriteMemo(NodeID(22), [0x20, 0x42, 0x30], None, self.writeCallBackCheck)
